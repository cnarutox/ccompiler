        ...
        if len(line) == 5:
            if line[3] == '+':
                if line[-1][0] == '#':
                    ...
                    return '\tadd %s,%s,%s' % (Get_R(line[0]), Get_R(line[2]),
                                               Get_R(line[-1]))
            elif line[3] == '-':
                if line[-1][0] == '#':
                    ...
                    return '\tsub %s,%s,%s' % (Get_R(line[0]), Get_R(line[2]),
                                               Get_R(line[-1]))
            elif line[3] == '*':
                return '\tmul %s,%s,%s' % (Get_R(line[0]), Get_R(line[2]),
                                           Get_R(line[-1]))
            elif line[3] == '/':
                return '\tdiv %s,%s\n\tmflo %s' % (Get_R(
                    line[2]), Get_R(line[-1]), Get_R(line[0]))
            elif line[3] == '<':
                return '\tslt %s,%s,%s' % (Get_R(line[0]), Get_R(line[2]),
                                           Get_R(line[-1]))
            elif line[3] == '>':
                return '\tslt %s,%s,%s' % (Get_R(line[0]), Get_R(line[-1]),
                                           Get_R(line[2]))
        if line[2] == 'CALL':
